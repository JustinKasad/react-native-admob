...
class FluidBanner extends Component {
...
FluidBanner.simulatorId = 'SIMULATOR';

FluidBanner.propTypes = {
  ...ViewPropTypes,
  ...
  /**
   * Array of test devices. Use FluidBanner.simulatorId for the simulator
   */
  testDevices: arrayOf(string),

  /**
   * Object of key/value pairs for custom key/value targeting
   */
...
const RNFluidBannerView = requireNativeComponent('RNFluidBannerView', FluidBanner);
